...
export default function Orange({ colors }) {
  ...
  const orange = colorNames.filter((color) => color[1].family === "Orange");
  return (
    <div className={styles.container}>
      <Head>
        <title>Oranges by Benjamin Moore</title>
        <meta
          name="description"
